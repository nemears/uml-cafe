...
export default class UMLRenderer extends BaseRenderer {
    constructor(eventBus) {
        super(eventBus);
        this.CONNECTION_STYLE = { fill: 'none', strokeWidth: 2, stroke: 'var(--vscode-foreground)' };
        this.LABEL_STYLE = { fill: 'none', stroke: 'var(--vscode-foreground)', strokeWidth: 0 };
    ...
    drawConnection(gfx, element, attrs) {
        if (element.umlType === 'generalization') {
            ...
            svgAttr(arrowTipPath, {
                style: 'fill:var(--vscode-foreground);stroke:var(--vscode-foreground);',
